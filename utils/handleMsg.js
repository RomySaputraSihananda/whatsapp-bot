...
const handleMsg = (msg, client) => {
  ...
  if (from.message.startsWith(".")) {
    if (from.message === ".help") {
      ...
      from.message.startsWith(".stiker") &&
      (msg.type === "image" || msg.type === "video")
    ) {
      return createSticker(msg, client);
    } else if (from.message === ".random") {
      return getImage(msg, client, "random");
    ...
    } else if (from.message === ".trap") {
      return getImage(msg, client, "trap");
    }
    ...
    from.message === "assalamualaikum" ||
    from.message === "assalamu'alaikum"
  ) {
